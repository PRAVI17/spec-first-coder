    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage contests, problems, and users</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground text-center py-8">Quick actions will appear here</p>
            </CardContent>
          </Card>
        </div>
      </main>
